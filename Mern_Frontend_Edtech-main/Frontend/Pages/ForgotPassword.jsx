...
const ForgotPassword = () => {
  ...
  return (
    <div className="grid min-h-[calc(100vh-3.5rem)] place-items-center">
        {
          loading ? (<div className="spinner text-white"> Loading .....</div> ) : (
               ...
               <form onSubmit={handleOnSubmit}>
                {
                    !emailSent && (
                        <label  className="w-full">
                            <p className="mb-1 text-[0.875rem] leading-[1.375rem] text-richblack-5">Email Addres*</p>
                            <input  type='email' required name='email' value={email} onChange={(e)=>(setEmail(e.target.value))}
                             placeholder='Enter Your Email Address' className="form-style w-full" />
                        </label>
                    )
                }
